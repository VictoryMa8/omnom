...
<template>
  <section class="meal-feed" :aria-busy="diary.loading">
    ...
    <div v-else-if="!meals.length && !diary.error" class="empty-state"><div class="empty-icon"><Utensils class="icon" /></div><h3>A fresh page for your day.</h3><p>Start with your first meal. A few words is all it takes.</p></div>
